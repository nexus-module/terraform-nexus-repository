...
| Name | Type |
|------|------|
| [nexus_repository_cargo_proxy.main](https://registry.terraform.io/providers/datadrivers/nexus/latest/docs/resources/repository_cargo_proxy) | resource |
...
| <a name="input_routing_rule"></a> [routing\_rule](#input\_routing\_rule) | The name of the routing rule assigned to this repository. | `string` | `null` | no |
